...
仍需用户单独批准。
0.5.0 发布候选已推送到 `origin/main@06f3af2`，CI run `33701019951` 的 Linux Node 22/24
与 Windows Node 24 矩阵全绿；市场收录复核仍为 `accepted`。
...
本地 `main` 与 `origin/main` 已同步到 `06f3af2`，工作树干净。
...
| 项 | 值 |
| --- | --- |
| 代码基线 | `main` / `origin/main@06f3af2`（0.5.0 发布候选） |
| 当前源码版本 | `0.5.0` 发布候选 |
