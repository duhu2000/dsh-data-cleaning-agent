...
| 三期 | 0.5.0 | 方案 A 扩展 Skill：风险/知产/经营 + 方案 B 批量后端 | 风险 38 + 知产 18 + 经营 35 | 同上；S7 PASS，G5-1 Host Bridge 已落地 |
...
- G5-1：允许列表、取消/超时、动态重注册、企业去重批量、多候选暂停和同源 Web 契约已通过 Mock 测试。
- 剩余 Gate：真实 OAuth 首连、token 刷新、真实 QCC 工具与计费/限流错误 E2E。
