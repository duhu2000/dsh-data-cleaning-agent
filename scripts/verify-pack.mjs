...
const WHITELIST = [
  ...
  /^docs\/(?:RELEASE-0\.9\.(?:11|12|13|14|15)|UNIFIED-HOME-1\.5\.4-ADOPTION|RELEASE-0\.8\.(?:16|17|18|19|20|21|22)|TEMPLATE-MAPPING-ACCEPTANCE)\.md$/,
  /^lib\/[^/]+\.js$/,
  /^docs\/(?:USER-GUIDE|FIRST-CONTRIBUTION|COMPATIBILITY|UI-V1\.5\.0-ADOPTION|QCC-ENRICHMENT-DESIGN|QCC-PHASES-ROADMAP|PHASE2-ACCEPTANCE|PHASE3-ACCEPTANCE|RELEASE-0\.4\.0|RELEASE-0\.5\.0|RELEASE-0\.5\.1|RELEASE-0\.5\.2|RELEASE-0\.5\.3|RELEASE-0\.6\.0|RELEASE-0\.6\.1|RELEASE-0\.6\.2|RELEASE-0\.6\.3|RELEASE-0\.7\.0|RELEASE-0\.8\.0|RELEASE-0\.8\.1|UI-WORKFLOW-V2|UI-WORKFLOW-V2-MIGRATION|UI-WORKFLOW-V2-ACCEPTANCE|G5-HOST-BRIDGE|G5-E2E-RUNBOOK)\.md$/,
];
