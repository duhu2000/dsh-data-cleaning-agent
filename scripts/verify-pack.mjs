...
const WHITELIST = [
  ...
  /^lib\/[^/]+\.js$/,
  /^docs\/(?:USER-GUIDE|FIRST-CONTRIBUTION|COMPATIBILITY|QCC-ENRICHMENT-DESIGN|QCC-PHASES-ROADMAP|PHASE2-ACCEPTANCE|RELEASE-0\.4\.0|G5-HOST-BRIDGE|G5-E2E-RUNBOOK)\.md$/,
];
