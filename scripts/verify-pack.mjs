...
const WHITELIST = [
  ...
  /^lib\/[^/]+\.js$/,
  /^docs\/(?:USER-GUIDE|FIRST-CONTRIBUTION|COMPATIBILITY|QCC-ENRICHMENT-DESIGN|QCC-PHASES-ROADMAP|PHASE2-ACCEPTANCE|PHASE3-ACCEPTANCE|RELEASE-0\.4\.0|RELEASE-0\.5\.0|RELEASE-0\.5\.1|RELEASE-0\.5\.2|RELEASE-0\.5\.3|RELEASE-0\.6\.0|RELEASE-0\.6\.1|RELEASE-0\.6\.2|RELEASE-0\.6\.3|RELEASE-0\.7\.0|RELEASE-0\.8\.0|RELEASE-0\.8\.1|UI-WORKFLOW-V2|UI-WORKFLOW-V2-MIGRATION|UI-WORKFLOW-V2-ACCEPTANCE|G5-HOST-BRIDGE|G5-E2E-RUNBOOK)\.md$/,
];
