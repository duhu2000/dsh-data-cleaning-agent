...
const WHITELIST = [
  ...
  /^lib\/[^/]+\.js$/,
  /^docs\/(?:USER-GUIDE|FIRST-CONTRIBUTION|COMPATIBILITY|QCC-ENRICHMENT-DESIGN|QCC-PHASES-ROADMAP|PHASE2-ACCEPTANCE|PHASE3-ACCEPTANCE|RELEASE-0\.4\.0|RELEASE-0\.5\.0|RELEASE-0\.5\.1|G5-HOST-BRIDGE|G5-E2E-RUNBOOK)\.md$/,
];
