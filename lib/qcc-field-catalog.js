...
export const QCC_FIELD_CATALOG = Object.freeze([
  group('company_registration', '企业工商信息', 'get_company_registration_info', [
    ...
    field('province', '省份', { sourcePath: '地区信息.省份' }),
    field('city', '城市', { sourcePath: '地区信息.城市' }),
    field('district', '区域', { sourcePath: '地区信息.区域' }),
    field('area_code', '地区代码', { sourcePath: '地区信息.地区代码' }),
    field('business_scope', '经营范围'),
    field('industry_category', '国标行业'),
    field('industry_section', '国标行业门类', { sourcePath: '国标行业.门类' }),
    field('industry_large', '国标行业大类', { sourcePath: '国标行业.大类' }),
    field('industry_middle', '国标行业中类', { sourcePath: '国标行业.中类' }),
    field('industry_small', '国标行业小类', { sourcePath: '国标行业.小类' }),
  ...
  group('company_profile', '企业简介', 'get_company_profile', [
    ...
    field('qcc_industry_level1', '企查查行业一级', { sourcePath: '企查查行业.一级' }),
    field('qcc_industry_level2', '企查查行业二级', { sourcePath: '企查查行业.二级' }),
    field('qcc_industry_level3', '企查查行业三级', { sourcePath: '企查查行业.三级' }),
    field('qcc_industry_level4', '企查查行业四级', { sourcePath: '企查查行业.四级' }),
    field('main_products', '主营产品', { sourcePath: '主营产品' }),
    field('company_scale', '企业规模', { sourcePath: '企业规模' }),
